...
/***********************************************************************************************************************/
	...
	constexpr bool conjunction(bool b1, bool b2)				{ return b1 && b2; }
	constexpr bool disjunction(bool b1, bool b2)				{ return b1 || b2; }
	constexpr bool implication(bool b1, bool b2)				{ return b1 || !b2; }
	constexpr bool equivalence(bool b1, bool b2)				{ return (b1 || !b2) && (!b1 || b2); }

	constexpr bool negation(bool b)						{ return !b; }
